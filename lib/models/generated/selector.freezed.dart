...
class _$VM4Impl<A, B, C, D> implements _VM4<A, B, C, D> {
  const _$VM4Impl(this.a, this.b, this.c, this.d);
...
abstract class _VM4<A, B, C, D> implements VM4<A, B, C, D> {
  const factory _VM4(final A a, final B b, final C c, final D d) =
      _$VM4Impl<A, B, C, D>;
...
mixin _$DashboardState {
  List<DashboardWidget> get dashboardWidgets =>
      throw _privateConstructorUsedError;
  double get contentWidth => throw _privateConstructorUsedError;
...
abstract class $DashboardStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<DashboardWidget> dashboardWidgets, double contentWidth});
}
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      contentWidth: null == contentWidth
          ? _value.contentWidth
          : contentWidth // ignore: cast_nullable_to_non_nullable
              as double,
    ) as $Val);
  }
}
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.contentWidth, contentWidth) ||
                other.contentWidth == contentWidth));
  }

  @override
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_dashboardWidgets), contentWidth);
...
abstract class _DashboardState implements DashboardState {
  const factory _DashboardState(
      {required final List<DashboardWidget> dashboardWidgets,
      required final double contentWidth}) = _$DashboardStateImpl;
...
mixin _$SelectedProxyState {
  ...
  @JsonKey(ignore: true)
  $SelectedProxyStateCopyWith<SelectedProxyState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SelectedProxyStateCopyWith<$Res> {
  factory $SelectedProxyStateCopyWith(
          SelectedProxyState value, $Res Function(SelectedProxyState) then) =
      _$SelectedProxyStateCopyWithImpl<$Res, SelectedProxyState>;
  @useResult
  $Res call({String proxyName, bool group, String? testUrl});
}

/// @nodoc
class _$SelectedProxyStateCopyWithImpl<$Res, $Val extends SelectedProxyState>
    implements $SelectedProxyStateCopyWith<$Res> {
  _$SelectedProxyStateCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$SelectedProxyStateImplCopyWith<$Res>
    implements $SelectedProxyStateCopyWith<$Res> {
  factory _$$SelectedProxyStateImplCopyWith(_$SelectedProxyStateImpl value,
          $Res Function(_$SelectedProxyStateImpl) then) =
      __$$SelectedProxyStateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String proxyName, bool group, String? testUrl});
}
...
/// @nodoc
class __$$SelectedProxyStateImplCopyWithImpl<$Res>
    extends _$SelectedProxyStateCopyWithImpl<$Res, _$SelectedProxyStateImpl>
    implements _$$SelectedProxyStateImplCopyWith<$Res> {
  __$$SelectedProxyStateImplCopyWithImpl(_$SelectedProxyStateImpl _value,
      $Res Function(_$SelectedProxyStateImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SelectedProxyStateImpl(
      proxyName: null == proxyName
          ? _value.proxyName
          : proxyName // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$SelectedProxyStateImpl implements _SelectedProxyState {
  const _$SelectedProxyStateImpl(
      {required this.proxyName, this.group = false, this.testUrl});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$SelectedProxyStateImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SelectedProxyStateImplCopyWith<_$SelectedProxyStateImpl> get copyWith =>
      __$$SelectedProxyStateImplCopyWithImpl<_$SelectedProxyStateImpl>(
          this, _$identity);
}

abstract class _SelectedProxyState implements SelectedProxyState {
  const factory _SelectedProxyState(
      {required final String proxyName,
      final bool group,
      final String? testUrl}) = _$SelectedProxyStateImpl;
...
mixin _$ProfileOverrideModel {
  ...
  @JsonKey(ignore: true)
  $ProfileOverrideModelCopyWith<ProfileOverrideModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ProfileOverrideModelCopyWith<$Res> {
  factory $ProfileOverrideModelCopyWith(ProfileOverrideModel value,
          $Res Function(ProfileOverrideModel) then) =
      _$ProfileOverrideModelCopyWithImpl<$Res, ProfileOverrideModel>;
  @useResult
  $Res call(
...
class _$ProfileOverrideModelCopyWithImpl<$Res,
        $Val extends ProfileOverrideModel>
    implements $ProfileOverrideModelCopyWith<$Res> {
  _$ProfileOverrideModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ProfileOverrideModelImplCopyWith<$Res>
    implements $ProfileOverrideModelCopyWith<$Res> {
  factory _$$ProfileOverrideModelImplCopyWith(_$ProfileOverrideModelImpl value,
          $Res Function(_$ProfileOverrideModelImpl) then) =
      __$$ProfileOverrideModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {ClashConfigSnippet snippet,
...
/// @nodoc
class __$$ProfileOverrideModelImplCopyWithImpl<$Res>
    extends _$ProfileOverrideModelCopyWithImpl<$Res, _$ProfileOverrideModelImpl>
    implements _$$ProfileOverrideModelImplCopyWith<$Res> {
  __$$ProfileOverrideModelImplCopyWithImpl(_$ProfileOverrideModelImpl _value,
      $Res Function(_$ProfileOverrideModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ProfileOverrideModelImpl(
      snippet: null == snippet
          ? _value.snippet
          : snippet // ignore: cast_nullable_to_non_nullable
              as ClashConfigSnippet,
...
class _$ProfileOverrideModelImpl implements _ProfileOverrideModel {
  const _$ProfileOverrideModelImpl(
      {this.snippet = const ClashConfigSnippet(),
      final Set<String> selectedRules = const {},
      this.overrideData})
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ProfileOverrideModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ProfileOverrideModelImplCopyWith<_$ProfileOverrideModelImpl>
      get copyWith =>
          __$$ProfileOverrideModelImplCopyWithImpl<_$ProfileOverrideModelImpl>(
              this, _$identity);
}

abstract class _ProfileOverrideModel implements ProfileOverrideModel {
  const factory _ProfileOverrideModel(
      {final ClashConfigSnippet snippet,
      final Set<String> selectedRules,
      final OverrideData? overrideData}) = _$ProfileOverrideModelImpl;
