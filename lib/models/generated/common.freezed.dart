...
class _$IpInfoImpl implements _IpInfo {
  const _$IpInfoImpl({required this.ip, required this.countryCode});
...
abstract class _IpInfo implements IpInfo {
  const factory _IpInfo(
      ...
      required final String countryCode}) = _$IpInfoImpl;
...
AndroidState _$AndroidStateFromJson(Map<String, dynamic> json) {
  return _AndroidState.fromJson(json);
}

/// @nodoc
mixin _$AndroidState {
  String get currentProfileName => throw _privateConstructorUsedError;
  String get stopText => throw _privateConstructorUsedError;
  bool get onlyStatisticsProxy => throw _privateConstructorUsedError;
  bool get crashlytics => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $AndroidStateCopyWith<AndroidState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AndroidStateCopyWith<$Res> {
  factory $AndroidStateCopyWith(
          AndroidState value, $Res Function(AndroidState) then) =
      _$AndroidStateCopyWithImpl<$Res, AndroidState>;
  @useResult
  $Res call(
...
/// @nodoc
class _$AndroidStateCopyWithImpl<$Res, $Val extends AndroidState>
    implements $AndroidStateCopyWith<$Res> {
  _$AndroidStateCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      currentProfileName: null == currentProfileName
          ...
          : currentProfileName // ignore: cast_nullable_to_non_nullable
              as String,
      stopText: null == stopText
          ? _value.stopText
          : stopText // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
abstract class _$$AndroidStateImplCopyWith<$Res>
    implements $AndroidStateCopyWith<$Res> {
  factory _$$AndroidStateImplCopyWith(
          _$AndroidStateImpl value, $Res Function(_$AndroidStateImpl) then) =
      __$$AndroidStateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String currentProfileName,
...
/// @nodoc
class __$$AndroidStateImplCopyWithImpl<$Res>
    extends _$AndroidStateCopyWithImpl<$Res, _$AndroidStateImpl>
    implements _$$AndroidStateImplCopyWith<$Res> {
  __$$AndroidStateImplCopyWithImpl(
      _$AndroidStateImpl _value, $Res Function(_$AndroidStateImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$AndroidStateImpl(
      currentProfileName: null == currentProfileName
          ? _value.currentProfileName
          : currentProfileName // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$AndroidStateImpl implements _AndroidState {
  const _$AndroidStateImpl(
      {required this.currentProfileName,
      required this.stopText,
      required this.onlyStatisticsProxy,
      required this.crashlytics});

  factory _$AndroidStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$AndroidStateImplFromJson(json);
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, currentProfileName, stopText,
      onlyStatisticsProxy, crashlytics);

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$AndroidStateImplCopyWith<_$AndroidStateImpl> get copyWith =>
      __$$AndroidStateImplCopyWithImpl<_$AndroidStateImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$AndroidStateImplToJson(
      this,
    );
  }
}

abstract class _AndroidState implements AndroidState {
  const factory _AndroidState(
      {required final String currentProfileName,
      required final String stopText,
      required final bool onlyStatisticsProxy,
      required final bool crashlytics}) = _$AndroidStateImpl;

  factory _AndroidState.fromJson(Map<String, dynamic> json) =
      _$AndroidStateImpl.fromJson;
...
/// @nodoc
abstract class _$$DelayStateImplCopyWith<$Res>
    implements $DelayStateCopyWith<$Res> {
  factory _$$DelayStateImplCopyWith(
          _$DelayStateImpl value, $Res Function(_$DelayStateImpl) then) =
      __$$DelayStateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({int delay, bool group});
}
...
/// @nodoc
class __$$DelayStateImplCopyWithImpl<$Res>
    extends _$DelayStateCopyWithImpl<$Res, _$DelayStateImpl>
    implements _$$DelayStateImplCopyWith<$Res> {
  __$$DelayStateImplCopyWithImpl(
      _$DelayStateImpl _value, $Res Function(_$DelayStateImpl) _then)
      : super(_value, _then);
...
class _$DelayStateImpl implements _DelayState {
  const _$DelayStateImpl({required this.delay, required this.group});
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DelayStateImplCopyWith<_$DelayStateImpl> get copyWith =>
      __$$DelayStateImplCopyWithImpl<_$DelayStateImpl>(this, _$identity);
}

abstract class _DelayState implements DelayState {
  const factory _DelayState(
      {required final int delay, required final bool group}) = _$DelayStateImpl;
